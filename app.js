...
const OFP_GROUPS = [
  ...
  { id: 'ofp-pvg',  shortName: 'PVG', color: '#E67E22',
    routeIds: ['RJTT-ZSPD', 'ZSPD-RJTT', 'RJBB-ZSPD', 'ZSPD-RJBB'],
    airports: ['HND', 'KIX', 'PVG'] },
  { id: 'ofp-tsa',  shortName: 'TSA', color: '#2ECC71',
    routeIds: ['RJTT-RCSS', 'RCSS-RJTT'],
    airports: ['HND', 'TSA'] },
  { id: 'ofp-tpe',  shortName: 'TPE', color: '#5DADE2',
    routeIds: ['RJBB-RCTP', 'RCTP-RJBB'],
    airports: ['KIX', 'TPE'] },
  ...
  { id: 'ofp-lax',  shortName: 'LAX', color: '#CD6155',
    routeIds: ['RJBB-KLAX', 'KLAX-RJBB'],
    airports: ['KIX', 'LAX'], defaultOff: true },
  ...
  { id: 'ofp-fra',  shortName: 'FRA', color: '#C0392B',
    routeIds: ['EDDF-RJAA', 'RJAA-EDDF-2', 'RJAA-EDDF-3', 'EDDF-RJAA-2', 'EDDF-RJAA-3', 'EDDF-RJAA-4', 'EDDF-RJAA-5', 'RJAA-EDDF-4', 'EDDF-RJAA-6', 'RJAA-EDDF-5'],
